...
class ProfileCanBoScreen extends StatefulWidget {
  const ProfileCanBoScreen({super.key});

  @override
  State<ProfileCanBoScreen> createState() => _ProfileCanBoScreenState();
}
        ...
        child: Column(
          children: [
            ...
            Button_Account_Screen(
              ...
              onTap: () async {
                Get.toNamed(RouteManager.readCanBoInfo);
              },
            ),
